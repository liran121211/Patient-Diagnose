...
public class Diagnoses {
    ...
    private final String[][] treatments_data = new String[][]{
    ...
    //Constructor
    protected Diagnoses() {
        for (String[] treatments_datum : treatments_data) treatments_dict.put(treatments_datum[0], treatments_datum[1]);
    }
    ...
    private void calc_alkaline(double value, String ethnic) {
    ...
    protected ArrayList<String> wbc_arr() {
        return wbc;
    }

    protected ArrayList<String> neut_arr() {
        return neut;
    }

    protected ArrayList<String> lymp_arr() {
        return lymp;
    }

    protected ArrayList<String> rbc_arr() {
        return rbc;
    }

    protected ArrayList<String> hct_arr() {
        return hct;
    }

    protected ArrayList<String> urea_arr() {
        return urea;
    }

    protected ArrayList<String> hb_arr() {
        return hb;
    }

    protected ArrayList<String> creat_arr() {
        return creat;
    }

    protected ArrayList<String> iron_arr() {
        return iron;
    }

    protected ArrayList<String> hdl_arr() {
        return hdl;
    }

    protected ArrayList<String> alkaline_arr() {
        return alk;
    }
}