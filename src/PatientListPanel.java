...
public class PatientListPanel extends JPanel implements ActionListener, ListSelectionListener, DocumentListener {
    ...
    private JLabel headlineLabel, listLabel, diagnoseLabel, treatmentLabel;
    ...
    protected PatientListPanel(ActionListener listener) {
        super();
        ...
        headlineLabel = new JLabel("<html><u><span style='font-size:15px'>Patient Details:</span></u></html>");
    ...
    protected void init() {
        ...
        headlineLabel.setBounds(380, 10, 150, 40);
    ...
    private void writePatient(String name) {
        patientFile = new File(name + ".txt");
        try {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == exportButton)
            writePatient(patientsList.getSelectedValue());
    }
    ...
    protected String ethnic_value_form() {
        return ethnic.getSelectedItem().toString();
    }
